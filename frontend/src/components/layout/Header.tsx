        ...
        <header className="sticky top-0 z-40 flex h-16 shrink-0 items-center justify-between gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
                <form className="relative flex flex-1" action="#" method="GET">
                    ...
                    <input
                        ...
                        placeholder="Buscar leads, unidades ou tarefas..."
                        type="search"
                        name="search"
                    />
                </form>
            ...
            <div className="flex items-center gap-x-4 lg:gap-x-6">
                ...
                >
                    ...
                    {/* Badge para tarefas atrasadas ex. */}
                    <span className="absolute top-2 right-2 flex h-2.5 w-2.5 items-center justify-center rounded-full bg-red-600 ring-2 ring-white"></span>
                </button>
